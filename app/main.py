...
from app.core.customer_data_loader import CustomerShoppingDataLoader, load_and_prepare_customer_data
from app.core.narrative_generator import NarrativeGenerator
from app.core.visualization import DataVisualizer
...
def load_data():
    ...
    try:
        ...
        # Ensure datetime compatibility for Streamlit
        if cleaned_data is not None and 'invoice_date' in cleaned_data.columns:
            # Convert datetime to string for better Streamlit compatibility
